using Muzi.ExcelExport.net45.DemoUI.Models;
...
namespace Muzi.ExcelExport.net45.DemoUI.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Demo1()
        {
            ...
            {
                new ExportColumn() { Label = "姓名", Prop = "Name" },
                new ExportColumn() { Label = "底薪", Prop = "BaseSalary" },
                new ExportColumn() { Label = "是否全勤", Prop = "IsFullAttendance", },
                new ExportColumn() { Label = "交通", Prop = "Transportation" },
                new ExportColumn() { Label = "餐补", Prop = "Meal", },
                new ExportColumn() { Label = "创建时间", Prop = nameof(Salary.CreateTime) },
            };
        ...
        public ActionResult Demo2()
        {
            ...
            List<ExportColumn> columns = new List<ExportColumn>()
            {
                ...
                {
                    Label = "工资",
                    Children = new  List<ExportColumn>()
                    {
                        new ExportColumn() { Label = "底薪", Prop = "BaseSalary" },
                        new ExportColumn() { Label = "全勤", Prop = "FullAttendance" },
                        new ExportColumn()
                        {
                            Label = "补助",
                            Children = new List<ExportColumn>()
        ...
        public ActionResult Demo5()
        {
            ...
            List<ExportColumn> columns = new List<ExportColumn>()
            {
                ...
                new ExportColumn() { Label = "交通", Prop = "Transportation" },
                new ExportColumn() { Label = "餐补", Prop = "Meal" },
                new ExportColumn() { Label = "合计", Prop = "Total" },
            };
        ...
        public ActionResult Demo6()
        {
            ...
            List<ExportColumn> columns = new List<ExportColumn>()
            {
                new ExportColumn() { Label = "姓名", Prop = "Name", Width = 200 },
                new ExportColumn() { Label = "底薪", Prop = "BaseSalary", Width = 200 },
                new ExportColumn() { Label = "全勤", Prop = "FullAttendance", Width = 200 },
                new ExportColumn() { Label = "交通", Prop = "Transportation", Width = 200 },
                new ExportColumn() { Label = "餐补", Prop = "Meal", Width = 200 },
                new ExportColumn() { Label = "时间", Prop = "CreateTime", Width = 300 },
            };
